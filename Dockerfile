...
RUN mkdir -p /go/src/github.com/spidercatnat/txwifi
COPY . /go/src/github.com/spidercatnat/txwifi

RUN CGO_ENABLED=0 go build -a -installsuffix cgo -o /go/bin/wifi /go/src/github.com/spidercatnat/txwifi/main.go
